            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                ...
                <form method="POST" action="{{ route('faqs.update', $faq->id) }}" >
                    ...
                    <div class="mt-4 px-4">
                        ...
                        <x-input id="title" class="block mt-1 w-full" type="text" name="title" :value=" $faq->title"
                            required  />
                    </div>
                    <div wire:ignore class="form-group row mt-4 px-4">
                        <x-label for="description" value="{{ __('Conteúdo') }}" />
                        <div class="col-md-9">
                            <textarea wire:model="message" class="form-control required" name="description" id="message">{{ $faq->description }}</textarea>
