                    ...
                    <div class="py-12">
                        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                            ...
                            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                                ...
                                <form method="POST" action="{{ route('paginas.update', $page->id) }}" enctype="multipart/form-data">
                                    @csrf
                                    @method('put')
                                    <div class="card">
                                        <div class="lg:flex">
                                            <div class="lg:w-2/6 p-8">
                                                <p><strong class="headings-color">Atualizar Página</strong></p>
                                            ...
                                            <div class="lg:w-4/6 card-dark p-8">
                                                <label class="block">
                                                    ...
                                                    <input class="form-input mt-1 block w-full placeholder-muted"
                                                        name="title" placeholder="Título" value="{{ $page->title }}">
                                                </label>
                                                ...
                                                <label class="block">
                                                    ...
                                                    <input class="form-input mt-1 block w-full placeholder-muted"
                                                        ...
                                                        value="{{ $page->briefDescription }}">
                                                </label>
                                                <label class="block">
                                                    <div class="col-md-9">
                                                        <span class="form-label">Texto</span>

                                                        <textarea class="form-control" id="description" placeholder="Insira o texto" name="description">{{ $page->description }}</textarea>
