...
@section('content')
    <section id="hero-animated" class="hero-animated d-flex align-items-center">
        <div class="container d-flex flex-column justify-content-center align-items-center text-center position-relative"
            ...
            <p style="color:#fff!important">Et voluptate esse accusantium accusamus natus reiciendis quidem voluptates similique aut.</p>
            <div class="d-flex">
                ...
                @php $useragent=$_SERVER['HTTP_USER_AGENT']; @endphp
                                    ...
                                    <a id="whats-menu"  href="https://api.whatsapp.com/send?phone={{  $configuration->whatsapp }}&amp;text=Entrei em contato através do site {{ Request::url() }}" class="btn-get-started scrollto" title="Orçamento" target="_blank"><i
                                        class="bi bi-whatsapp"></i> Fale Conosco</a>
                                    @else
                                    <a id="whats-menu" href="https://web.whatsapp.com/send?phone={{  $configuration->whatsapp }}&amp;text=Entrei em contato através do site {{ Request::url() }}" class="btn-get-started scrollto"  title="Orçamento" target="_blank"><i
                                        class="bi bi-whatsapp"></i> Fale Conosco</a>
                                    @endif</li>
                <a href="https://www.youtube.com/watch?v=LXb3EKWsInQ"
                    class="glightbox btn-watch-video d-flex align-items-center"><i class="bi bi-play-circle" style="color:#fff!important"></i><span style="color:#fff!important">Assista ao
                        Video</span></a>
            </div>
        </div>
    </section>
        ...
        <section id="about" class="about">
            <div class="container" data-aos="fade-up">
                ...
                <div class="row g-4 g-lg-5" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <div class="col-lg-5">
                        <div class="about-img">
                            <img src="{{ asset('site/assets/img/adovogados em bh.webp') }}" class="img-fluid" alt="Advogados em BH">
                        </div>
                    </div>
        ...
        <div class="container" data-aos="fade-up">
          ...
          <div class="row">
            ...
            <div class="col-lg-4" data-aos="fade-up" data-aos-delay="200">
              <div class="post-box">
                <div class="post-img"><img src="{{ asset('site/assets/img/blog/blog-1.jpg') }}" class="img-fluid" alt=""></div>
                <div class="meta">
            ...
            <div class="col-lg-4" data-aos="fade-up" data-aos-delay="400">
              <div class="post-box">
                <div class="post-img"><img src="{{ asset('site/assets/img/blog/blog-2.jpg') }}" class="img-fluid" alt=""></div>
                <div class="meta">
            ...
            <div class="col-lg-4" data-aos="fade-up" data-aos-delay="600">
              <div class="post-box">
                <div class="post-img"><img src="{{ asset('site/assets/img/blog/blog-3.jpg') }}" class="img-fluid" alt=""></div>
                <div class="meta">
