            ...
            <div class="container">
                ...
                <div class="row gy-5 gx-lg-5">
                    <div class="col-lg-12">
                        ...
                        <p><span style="color: rgb(68, 68, 68);">A sua privacidade é importante para nós. É política do Nome
                                do Site respeitar a sua privacidade em relação a qualquer informação sua que possamos
                                coletar no site <a href="{{ env('APP_URL') }}">{{ $configuration->company }}</a>, e outros sites que
                        ...
                        <p><span style="color: rgb(68, 68, 68);">O usuário se compromete a fazer uso adequado dos conteúdos
                                e da informação que o {{ $configuration->company }} oferece no site e com caráter enunciativo, mas não
                                limitativo:</span></p>
                        <ul>
                            ...
                            <li><span style="color: rgb(68, 68, 68);">C) Não causar danos aos sistemas físicos (hardwares) e
                                    lógicos (softwares) do {{ $configuration->company }}, de seus fornecedores ou terceiros, para introduzir
                                    ou disseminar vírus informáticos ou quaisquer outros sistemas de hardware ou software
                                    que sejam capazes de causar danos anteriormente mencionados.</span></li>
                        </ul>
                        ...
                        <p><span style="color: rgb(68, 68, 68);">Esperemos que esteja esclarecido e, como mencionado
                                ...
                                site.</span></p>
                        <p><span style="color: rgb(68, 68, 68);">Esta política é efetiva a partir de&nbsp;3 September 2023
                                02:06</span></p>
                    </div>
